<%@ Page Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="Order.aspx.cs" Inherits="UserInBox_Order" Title="Welcome to orders" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width: 100px; position: static; height: 100px" align="center">
        <head runat="server">
        <tr>
            <td colspan="2">
        ...
        <tr>
            ...
            <td style="width: 100px">
                <asp:RadioButton ID="RadioButton2" runat="server" GroupName="a" Style="position: static"
                    Text="Drafts and Cheque" Width="181px" /></td>
        </tr>
        <tr>
