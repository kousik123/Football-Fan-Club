<%@ Page Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="ProductGallery.aspx.cs" Inherits="UserInBox_ProductGallery" Title="Welcome to product gallery" %>
            ...
            <tr>
                <td colspan="6" style="height: 51px">
                    ...
                    Select Item For :</td>
                                ...
                                <td bgcolor="#33ccff" style="width: 100px">
                    Select PriceRange :</td>
                                <td bgcolor="#33ccff" style="width: 100px">
                    <asp:DropDownList ID="DropDownList3" runat="server" Style="position: static" AutoPostBack="True" OnSelectedIndexChanged="DropDownList3_SelectedIndexChanged">
                    </asp:DropDownList></td>
                    ...
                    <asp:Button ID="Button1" runat="server" Style="position: static" Text="Search >>" OnClick="Button1_Click" /></td>
                                <td>
                                    <asp:Button ID="Button3" runat="server" Text="price search" OnClick="Button3_Click" />
                                </td>
                            </tr>
                        </table>
                    </div>
